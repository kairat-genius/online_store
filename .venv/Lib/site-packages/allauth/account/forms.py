...
class PasswordField(forms.CharField):
    def __init__(self, *args, **kwargs):
        ...
        kwargs["widget"] = forms.PasswordInput(
            ...
            attrs={"placeholder": kwargs.get("label"), "class": "input100"},
        )
...
class LoginForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if app_settings.AUTHENTICATION_METHOD == AuthenticationMethod.EMAIL:
            ...
            login_widget = forms.TextInput(
                attrs={"placeholder": _("Username"), "autocomplete": "username", "class": "input100"}
            )
            ...
            login_widget = forms.TextInput(
                attrs={"placeholder": _("Username or e-mail"), "autocomplete": "email", "class": "input100"}
            )
            login_field = forms.CharField(
...
class AddEmailForm(UserForm):
    ...
    email = forms.EmailField(
        ...
        required=True,
        widget=forms.TextInput(
            attrs={"type": "email", "placeholder": _("E-mail address"), "class": "input100"}
        ),
    )
